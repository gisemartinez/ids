	...
	<div class="row card-fab-row">
		<div class="col s12 offset-m1 m10 offset-l2 l8 card-fab-col">
			<div class="card card-fab">
				...
				<g:form url="[resource:ubicacionInstance, action:'save']" id="form_create" class="form-fab">
					<div class="card-image">
						<asset:image src="sample-1.jpg"/>
						<span class="card-title">Crear Ubicación</span>
					</div>
				...
				<div class="card-action">
					<a id="create" data-card-height="813" style="cursor:pointer">Cancelar</a>
	...
	<!-- FAB -->
	<a id="create" class="btn-floating btn-large waves-effect waves-light red" data-card-height="813" style="position: fixed; bottom: 15px; right: 15px;">
