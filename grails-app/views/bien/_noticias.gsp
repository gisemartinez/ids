...
<ul class="dropdown-menu" role="menu">
	...
	<li><a>En uso</a><span class="badge">${cantEU}</span></li>
	<li><a>A donar</a><span class="badge">${cantAD}</span></li>
	<li><a>A descarte</a><span class="badge">${cantADsc}</span></li>
	<li><a>De baja</a><span class="badge">${cantB}</span></li>
</ul>
