		...
		<nav class="navbar navbar-default barra_acciones" role="navigation">
			<div class="container-fluid" style="padding-left:5px;padding-right:25px">
				<ul class="nav navbar-nav navbar-left">
					<li>
						<g:link action="show" resource="${personaInstance}" style="padding: 0px 12px; color:#777777"><i class="md md-arrow-back"></i></g:link>
					</li>
					<li><a>Editar</a></li>
				</ul>
		...
		<div class="container-fluid">
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<g:form url="[resource:personaInstance, action:'update']" method="PUT" id="form_edit_persona">
				...
				<div class="panel-footer" >
					<button class="btn btn-link" type="submit" form="form_edit_persona" style="padding: 0px 12px; color:#777777">
						<i class="md md-check"></i>
					</button>
					<g:link action="index" resource="${personaInstance}" style="padding: 0px 12px; color:#777777"><i class="md md-close"></i></g:link>
				</div>
			</div>
			<!-- panel-primary -->
		</div>
