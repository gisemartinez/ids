...
public class EliminarBien {
  ...
  @Test
  public void testEliminarBien() throws Exception {
    driver.get(baseUrl + "/abm/bien/index");
    driver.findElement(By.linkText("A Evaluar")).click();
    driver.findElement(By.linkText("A Descarte")).click();
